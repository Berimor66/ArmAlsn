...
class CMemDC_My : public CDC
{
public:

	// constructor sets up the memory DC
	CMemDC_My(CDC* pDC, LPRECT pRect = NULL, BOOL fCopyOld = FALSE) : CDC()
	{
		ASSERT(pDC != NULL);
	...
	CMemDC_My* operator->() {return this;}
		
	// Allow usage as a pointer
	operator CMemDC_My*() {return this;}

private:
	CBitmap  m_bitmap;      // Offscreen bitmap
	CBitmap* m_pOldBitmap;  // bitmap originally found in CMemDC_My
